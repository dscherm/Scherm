 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i0="FirebaseError";class Hn extends Error{constructor(t,s,i){super(s),this.code=t,this.customData=i,this.name=i0,Object.setPrototypeOf(this,Hn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Em.prototype.create)}}class Em{constructor(t,s,i){this.service=t,this.serviceName=s,this.errors=i}create(t,...s){const i=s[0]||{},r=`${this.service}/${t}`,o=this.errors[t],l=o?r0(o,i):"Error",c=`${this.serviceName}: ${l} (${r}).`;return new Hn(r,c,i)}}function r0(e,t){return e.replace(a0,(s,i)=>{const r=t[i];return r!=null?String(r):`<${i}?>`})}const a0=/\{\$([^}]+)}/g;class Pa{constructor(t,s,i){this.name=t,this.instanceFactory=s,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tx=K0;function Nn(e,t,s){var i;let r=(i=J0[e])!==null&&i!==void 0?i:e;s&&(r+=`-${s}`);const o=r.match(/\s|\//),l=t.match(/\s|\//);if(o||l){const c=[`Unable to register library "${r}" with version "${t}":`];o&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),rs.warn(c.join(" "));return}Ea(new Pa(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dx(e){Ea(new Pa("platform-logger",t=>new k0(t),"PRIVATE")),Ea(new Pa("heartbeat",t=>new ox(t),"PRIVATE")),Nn(Kl,Gu,e),Nn(Kl,Gu,"esm2017"),Nn("fire-js","")}dx("");var ux="firebase",hx="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Nn(ux,hx,"app");var Qu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tt={CANCELLED:"cancelled",INVALID_ARGUMENT:"invalid-argument",FAILED_PRECONDITION:"failed-precondition"};class Nt extends Hn{constructor(t,s){super(t,s),this.code=t,this.message=s,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
<body>
  ...
  <\/script>
    ...
    `,S=()=>{if(I(!1),R.current){const j=R.current.contentDocument||R.current.contentWindow.document;j.open(),j.write('<html><body style="background:#1a1a2e;color:#888;padding:20px;font-family:Arial;">Click "Run Code" to see your output</body></html>'),j.close()}},D=()=>{c(o.starterCode||""),S()},O=j=>{h.includes(j)||p([...h,j])},M=()=>{x(!0),c(o.solutionCode||"")},b=()=>{i||(r&&r({exerciseId:o.id,answer:l,isCorrect:!0,exerciseType:"objects-images",exerciseTitle:o.title}),s(o.id,o.points))},g=j=>`difficulty difficulty-${j.toLowerCase()}`,T=j=>{navigator.clipboard.writeText(j).then(()=>{alert("Code copied to clipboard!")})};return n.jsxs("div",{className:"exercise-detail objects-images-exercise",children:[n.jsx("button",{className:"back-button",onClick:t,children:"← Back to Week"}),n.jsxs("div",{className:"exercise-header-detail",children:[n.jsxs("div",{className:"exercise-meta",children:[n.jsx("span",{className:g(o.difficulty),children:o.difficulty}),n.jsxs("span",{className:"points",children:[o.points," pts"]}),o.id.includes("capstone")&&n.jsx("span",{className:"capstone-badge",children:"Capstone"})]}),n.jsx("h1",{children:o.title}),n.jsx("p",{className:"exercise-description-large",children:o.description})]}),o.explanation&&n.jsxs("div",{className:"explanation-section",children:[n.jsxs("button",{className:`explanation-toggle ${v?"open":""}`,onClick:()=>C(!v),children:[n.jsx("span",{className:"toggle-icon",children:v?"▼":"▶"}),n.jsxs("span",{className:"toggle-text",children:["📚 Learn: ",o.explanation.title]})]}),v&&n.jsxs("div",{className:"explanation-content",children:[n.jsxs("div",{className:"concept-section",children:[n.jsx("h4",{children:"Concept"}),n.jsx("pre",{className:"concept-text",children:o.explanation.concept})]}),o.explanation.example&&n.jsxs("div",{className:"example-section",children:[n.jsx("h4",{children:"Example (Different from this exercise!)"}),n.jsx("pre",{className:"example-code",children:n.jsx("code",{children:o.explanation.example})})]}),o.explanation.keyPoints&&o.explanation.keyPoints.length>0&&n.jsxs("div",{className:"key-points-section",children:[n.jsx("h4",{children:"Key Points"}),n.jsx("ul",{children:o.explanation.keyPoints.map((j,P)=>n.jsx("li",{children:j},P))})]})]})]}),o.vocabularyTerms&&o.vocabularyTerms.length>0&&n.jsxs("div",{className:"vocab-tags",children:[n.jsx("span",{className:"vocab-label",children:"Key Terms:"}),o.vocabularyTerms.map((j,P)=>n.jsx("span",{className:"vocab-tag",children:j},P))]}),n.jsxs("div",{className:"prompt-box",children:[n.jsx("h3",{children:"Challenge"}),n.jsx("pre",{children:o.prompt})]}),n.jsxs("div",{className:"editor-container",children:[n.jsxs("div",{className:"code-section",children:[n.jsxs("div",{className:"code-header",children:[n.jsx("h3",{children:"Your Code"}),n.jsxs("div",{className:"code-actions",children:[n.jsx("button",{onClick:m,className:"run-btn",children:"▶ Run"}),n.jsx("button",{onClick:S,className:"stop-btn",children:"⬛ Stop"}),n.jsx("button",{onClick:D,className:"reset-btn",children:"↺ Reset"}),n.jsx("button",{onClick:()=>T(l),className:"copy-btn",children:"📋 Copy"})]})]}),n.jsx("textarea",{className:"code-editor",value:l,onChange:j=>c(j.target.value),spellCheck:!1})]}),n.jsxs("div",{className:"canvas-section",children:[n.jsx("h3",{children:"Output"}),n.jsx("div",{className:"preview-container",children:n.jsx("iframe",{ref:R,title:"Code Preview",className:"code-preview-iframe",sandbox:"allow-scripts allow-same-origin"})})]})]}),n.jsxs("div",{className:"hints-section",children:[n.jsx("h3",{children:"Hints"}),n.jsx("div",{className:"hints-list",children:o.hints&&o.hints.map((j,P)=>n.jsx("div",{className:"hint-item",children:h.includes(P)?n.jsxs("div",{className:"hint-revealed",children:[n.jsxs("span",{className:"hint-number",children:["Hint ",P+1,":"]})," ",j]}):n.jsxs("button",{className:"hint-button",onClick:()=>O(P),children:["Reveal Hint ",P+1]})},P))})]}),o.resources&&o.resources.length>0&&n.jsxs("div",{className:"resources-section",children:[n.jsx("h3",{children:"Resources"}),n.jsx("div",{className:"resources-list",children:o.resources.map((j,P)=>n.jsx("a",{href:j.url,target:"_blank",rel:"noopener noreferrer",className:"resource-link",children:j.title},P))})]}),n.jsx("div",{className:"solution-section",children:w?n.jsxs("div",{className:"solution-revealed",children:[n.jsx("h3",{children:"Solution"}),n.jsx("pre",{className:"solution-code",children:o.solutionCode})]}):n.jsx("button",{className:"solution-button",onClick:M,children:"Show Solution (try on your own first!)"})}),n.jsx("div",{className:"complete-section",children:i?n.jsxs("div",{className:"already-completed",children:["✓ You've completed this exercise! (",o.points," points earned)"]}):n.jsxs("button",{className:"complete-button",onClick:b,children:["Mark as Complete (+",o.points," points)"]})})]})}function Wv(){Kc();const[e,t]=A.useState(null),[s,i]=A.useState(null),[r,o]=A.useState(null),[l,c]=A.useState(!1),[h,p]=A.useState(!1),[w,x]=A.useState("dashboard"),[v,C]=A.useState(null),[N,I]=A.useState(null),[R,m]=A.useState([]),[f,S]=A.useState([]),[D,O]=A.useState([]),[M,b]=A.useState(0),g=A.useRef(null),[T,j]=A.useState([]),[P,E]=A.useState(null),[k,Q]=A.useState(null),[U,K]=A.useState([]),[se,_]=A.useState([]),[H,z]=A.useState({}),[$,Z]=A.useState(null),[W,J]=A.useState(null),[ee,Y]=A.useState(null),[q,ie]=A.useState([]),[ve,we]=A.useState(null),[ye,Je]=A.useState(null),[Qe,it]=A.useState([]),[Lt,Ot]=A.useState(null),[Yn,Vn]=A.useState(null);A.useEffect(()=>{const V=localStorage.getItem("cyberrange-session");if(V)try{const Ie=JSON.parse(V);Ie.user&&(t(Ie.user),Gn(Ie.user))}catch(Ie){console.error("Error loading session:",Ie)}const te=localStorage.getItem("cyberrange-teacher-session");if(te)try{const Ie=JSON.parse(te);Ie.teacher&&i(Ie.teacher)}catch(Ie){console.error("Error loading teacher session:",Ie)}return()=>{g.current&&(g.current(),g.current=null)}},[]);const Gn=async V=>{if($n(),V.classCode){j([]);const te=Um(V.classCode,Ie=>{j(Ie)});g.current=te}},$n=()=>{const V=localStorage.getItem("cyberrange-progress");if(V)try{const te=JSON.parse(V);m(te.completed||[]),S(te.completedScenarios||[]),O(te.completedExercises||[]),K(te.completedPseudocode||[]),_(te.completedFlowcharts||[]),ie(te.completedDataApisExercises||[]),it(te.completedObjectsImagesExercises||[]),z(te.exitTicketResponses||{}),b(te.points||0)}catch(te){console.error("Error loading local progress:",te)}},qn=A.useCallback(async(V,te,Ie,_s,ii,gr,yr,lo,sn)=>{localStorage.setItem("cyberrange-progress",JSON.stringify({completed:V,completedScenarios:te,completedExercises:Ie,completedPseudocode:_s,completedFlowcharts:ii,completedDataApisExercises:gr,completedObjectsImagesExercises:yr,exitTicketResponses:lo,points:sn}))},[e]);A.useEffect(()=>{e&&qn(R,f,D,U,se,q,Qe,H,M)},[R,f,D,U,se,q,Qe,H,M,e,qn]);const Qa=V=>{g.current&&(g.current(),g.current=null),t(V),localStorage.setItem("cyberrange-session",JSON.stringify({user:V})),V.completedChallenges&&(m(V.completedChallenges),S(V.completedScenarios||[]),O(V.completedExercises||[]),b(V.totalPoints||0)),Gn(V)},Xn=V=>{i(V),c(!1),localStorage.setItem("cyberrange-teacher-session",JSON.stringify({teacher:V}))},Kn=V=>{o(V)},lr=()=>{o(null)},Ae=()=>{i(null),o(null),c(!1),localStorage.removeItem("cyberrange-teacher-session")},Le=()=>{g.current&&(g.current(),g.current=null),t(null),o(null),m([]),S([]),O([]),K([]),_([]),ie([]),it([]),z({}),j([]),b(0),x("dashboard"),E(null),Q(null),Z(null),J(null),Y(null),we(null),Je(null),Ot(null),Vn(null),localStorage.removeItem("cyberrange-session")},en=V=>{C(V),x("challenges")},cr=V=>{I(V),x("challenge-detail")},dr=(V,te)=>{R.includes(V)||(m([...R,V]),b(M+te))},Za=()=>{I(null),x("challenges")},_t=()=>{C(null),I(null),x("dashboard")},ur=(V,te)=>{f.includes(V)||(S([...f,V]),b(M+te))},hr=()=>{window.confirm("Are you sure you want to reset all progress? This cannot be undone.")&&(m([]),S([]),O([]),K([]),_([]),ie([]),it([]),z({}),b(0),localStorage.removeItem("cyberrange-progress"),x("dashboard"))},Jn=V=>{E(V),x("week")},eo=V=>{Q(V),x("exercise-detail")},to=(V,te)=>{D.includes(V)||(O([...D,V]),b(M+te))},Qn=(V,te,Ie)=>{z(_s=>({..._s,[V]:te}))},pr=()=>{Q(null),x("week")},so=()=>{E(null),x("dashboard")},Ds=V=>{x(V==="pseudocode"?"pseudocode-hub":"flowchart-hub")},Zn=V=>{Z(V),x("topic-lesson")},Rs=V=>{J(V),x("pseudocode-exercise")},os=(V,te)=>{U.includes(V)||(K([...U,V]),b(M+te))},ei=V=>{Y(V),x("flowchart-exercise")},ti=(V,te)=>{se.includes(V)||(_([...se,V]),b(M+te))},Wt=async V=>{if(!(!e||e.id==="demo"))try{await Tx(e.id,V.exerciseId,{answer:V.answer,isCorrect:V.isCorrect,exerciseType:V.exerciseType,exerciseTitle:V.exerciseTitle})}catch(te){console.error("Error saving submission:",te)}},Yt=()=>{x("dashboard")},mr=()=>{x("dashboard")},Oe=()=>{Z(null),x("pseudocode-hub")},fr=()=>{J(null),x("pseudocode-hub")},Ls=()=>{Y(null),x("flowchart-hub")},Os=V=>{we(V),x("data-apis-week")},no=V=>{Je(V),x("data-apis-exercise")},io=(V,te)=>{q.includes(V)||(ie([...q,V]),b(M+te))},ls=()=>{Je(null),x("data-apis-week")},ro=()=>{we(null),x("dashboard")},ao=V=>{Ot(V),x("objects-images-week")},si=V=>{Vn(V),x("objects-images-exercise")},oo=(V,te)=>{Qe.includes(V)||(it([...Qe,V]),b(M+te))},ni=()=>{Vn(null),x("objects-images-week")},tn=()=>{Ot(null),x("dashboard")};return l?n.jsx(Fx,{onLogin:Xn,onBack:()=>c(!1)}):s&&!r?n.jsx(zx,{teacher:s,onSelectClass:Kn,onLogout:Ae}):s&&r?n.jsx(xv,{classCode:r,onBack:lr}):e?n.jsxs("div",{className:"app",children:[n.jsx("header",{className:"header",children:n.jsxs("div",{className:"header-content",children:[n.jsx("div",{className:"logo",children:"CyberEd Range"}),n.jsxs("nav",{className:"nav",children:[n.jsx("button",{className:`nav-btn ${w==="dashboard"?"active":""}`,onClick:_t,children:"Dashboard"}),n.jsx("button",{className:`nav-btn ${w==="network-monitor"?"active":""}`,onClick:()=>x("network-monitor"),children:"Network Monitor"}),n.jsx("button",{className:`nav-btn ${w==="tools"?"active":""}`,onClick:()=>x("tools"),children:"Tools"}),n.jsx("button",{className:`nav-btn ${w==="vocabulary"?"active":""}`,onClick:()=>x("vocabulary"),children:"Vocabulary"}),n.jsx("button",{className:"nav-btn theme-btn",onClick:()=>p(!0),title:"Change Theme",children:"Theme"}),n.jsx("button",{className:"nav-btn",onClick:hr,style:{background:"rgba(244, 67, 54, 0.2)",borderColor:"#f44336"},children:"Reset"}),n.jsxs("div",{className:"user-info",children:[n.jsx("span",{className:"user-name",children:e==null?void 0:e.name}),n.jsx("span",{className:"user-class",children:e==null?void 0:e.classCode}),n.jsx("button",{className:"logout-btn",onClick:Le,children:"Logout"})]})]})]})}),n.jsxs("main",{className:"main-content",children:[w==="dashboard"&&n.jsx(Ky,{studentName:e==null?void 0:e.name,totalPoints:M,assignments:T,completedChallenges:R,completedScenarios:f,completedExercises:D,completedPseudocode:U,completedFlowcharts:se,completedDataApisExercises:q,completedObjectsImagesExercises:Qe,onSelectCategory:en,onSelectNetworkMonitor:()=>x("network-monitor"),onSelectWeek:Jn,onSelectAPCSP:Ds,onSelectDataApisWeek:Os,onSelectObjectsImagesWeek:ao}),w==="challenges"&&v&&n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"back-btn",onClick:_t,children:"Back to Dashboard"}),n.jsx("div",{style:{marginTop:"1rem"},children:n.jsx(Hx,{category:v,completedChallenges:R,onSelectChallenge:cr})})]}),w==="challenge-detail"&&N&&n.jsx(Ux,{challengeId:N,onComplete:dr,onBack:Za,isCompleted:R.includes(N),onSubmit:Wt}),w==="week"&&P&&n.jsx(bv,{weekKey:P,onSelectExercise:eo,onBack:so,completedExercises:D,exitTicketResponses:H,onSubmitExitTicket:Qn}),w==="exercise-detail"&&k&&n.jsx(kv,{exerciseId:k,onComplete:to,onBack:pr,isCompleted:D.includes(k),onSubmit:Wt}),w==="vocabulary"&&n.jsx(Bx,{}),w==="tools"&&n.jsx(hv,{}),w==="network-monitor"&&n.jsx(rv,{completedScenarios:f,onCompleteScenario:ur,onBack:_t}),w==="pseudocode-hub"&&n.jsx(jv,{completedExercises:U,onSelectTopic:Zn,onSelectExercise:Rs,onBack:Yt}),w==="topic-lesson"&&$&&n.jsx(Sv,{topicId:$,onBack:Oe,onSelectExercise:Rs}),w==="pseudocode-exercise"&&W&&n.jsx(Cv,{exerciseId:W,onComplete:os,onBack:fr,isCompleted:U.includes(W),onNextExercise:Rs,onSubmit:Wt}),w==="code-tracer"&&n.jsx(Tv,{onBack:Yt}),w==="robot-grid"&&n.jsx(Nv,{onBack:Yt}),w==="flowchart-hub"&&n.jsx(Pv,{completedExercises:se,onSelectExercise:ei,onSelectBuilder:()=>x("flowchart-builder"),onSelectSymbols:()=>x("symbol-lesson"),onBack:mr}),w==="symbol-lesson"&&n.jsx(Ev,{onBack:()=>x("flowchart-hub")}),w==="flowchart-exercise"&&ee&&n.jsx(Dv,{exerciseId:ee,onComplete:ti,onBack:Ls,isCompleted:se.includes(ee),onNextExercise:ei,onSubmit:Wt}),w==="flowchart-builder"&&n.jsx(Iv,{onBack:()=>x("flowchart-hub")}),w==="data-apis-week"&&ve&&n.jsx(Rv,{weekKey:ve,onSelectExercise:no,onBack:ro,completedExercises:q}),w==="data-apis-exercise"&&ye&&n.jsx(zv,{exerciseId:ye,onComplete:io,onBack:ls,isCompleted:q.includes(ye),onSubmit:Wt}),w==="data-apis-vocabulary"&&n.jsx(Hv,{onBack:_t}),w==="objects-images-week"&&Lt&&n.jsx(Uv,{weekKey:Lt,onSelectExercise:si,onBack:tn,completedExercises:Qe}),w==="objects-images-exercise"&&Yn&&n.jsx(Bv,{exerciseId:Yn,onComplete:oo,onBack:ni,isCompleted:Qe.includes(Yn),onSubmit:Wt})]}),h&&n.jsx(Xc,{onClose:()=>p(!1)})]}):n.jsx(pv,{onLogin:Qa,onTeacherLogin:()=>c(!0)})}el.createRoot(document.getElementById("root")).render(n.jsx(Sf.StrictMode,{children:n.jsx(Wv,{})}));
