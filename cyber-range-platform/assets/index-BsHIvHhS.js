 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(M,B){var O=M.length;M.push(B);e:for(;0<O;){var U=O-1>>>1,Z=M[U];if(0<r(Z,B))M[U]=B,M[O]=Z,O=U;else break e}}function s(M){return M.length===0?null:M[0]}function i(M){if(M.length===0)return null;var B=M[0],O=M.pop();if(O!==B){M[0]=O;e:for(var U=0,Z=M.length,Y=Z>>>1;U<Y;){var $=2*(U+1)-1,J=M[$],H=$+1,q=M[H];if(0>r(J,O))H<Z&&0>r(q,J)?(M[U]=q,M[H]=O,U=H):(M[U]=J,M[$]=O,U=$);else if(H<Z&&0>r(q,O))M[U]=q,M[H]=O,U=H;else break e}}return B}function r(M,B){var O=M.sortIndex-B.sortIndex;return O!==0?O:M.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,c=l.now();e.unstable_now=function(){return l.now()-c}}var h=[],p=[],w=1,x=null,v=3,C=!1,N=!1,I=!1,R=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(M){for(var B=s(p);B!==null;){if(B.callback===null)i(p);else if(B.startTime<=M)i(p),B.sortIndex=B.expirationTime,t(h,B);else break;B=s(p)}}function D(M){if(I=!1,S(M),!N)if(s(h)!==null)N=!0,ee(_);else{var B=s(p);B!==null&&se(D,B.startTime-M)}}function _(M,B){N=!1,I&&(I=!1,m(g),g=-1),C=!0;var O=v;try{for(S(B),x=s(h);x!==null&&(!(x.expirationTime>B)||M&&!P());){var U=x.callback;if(typeof U=="function"){x.callback=null,v=x.priorityLevel;var Z=U(x.expirationTime<=B);B=e.unstable_now(),typeof Z=="function"?x.callback=Z:x===s(h)&&i(h),S(B)}else i(h);x=s(h)}if(x!==null)var Y=!0;else{var $=s(p);$!==null&&se(D,$.startTime-B),Y=!1}return Y}finally{x=null,v=O,C=!1}}var z=!1,b=null,g=-1,T=5,k=-1;function P(){return!(e.unstable_now()-k<T)}function E(){if(b!==null){var M=e.unstable_now();k=M;var B=!0;try{B=b(!0,M)}finally{B?j():(z=!1,b=null)}}else z=!1}var j;if(typeof f=="function")j=function(){f(E)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,X=Q.port2;Q.port1.onmessage=E,j=function(){X.postMessage(null)}}else j=function(){R(E,0)};function ee(M){b=M,z||(z=!0,j())}function se(M,B){g=R(function(){M(e.unstable_now())},B)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){N||C||(N=!0,ee(_))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return s(h)},e.unstable_next=function(M){switch(v){case 1:case 2:case 3:var B=3;break;default:B=v}var O=v;v=B;try{return M()}finally{v=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,B){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var O=v;v=M;try{return B()}finally{v=O}},e.unstable_scheduleCallback=function(M,B,O){var U=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?U+O:U):O=U,M){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=O+Z,M={id:w++,callback:B,priorityLevel:M,startTime:O,expirationTime:Z,sortIndex:-1},O>U?(M.sortIndex=O,t(p,M),s(h)===null&&M===s(p)&&(I?(m(g),g=-1):I=!0,se(D,O-U))):(M.sortIndex=Z,t(h,M),N||C||(N=!0,ee(_))),M},e.unstable_shouldYield=P,e.unstable_wrapCallback=function(M){var B=v;return function(){var O=v;v=B;try{return M.apply(this,arguments)}finally{v=O}}}})(Nh);Th.exports=Nh;var If=Th.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i0="FirebaseError";class Un extends Error{constructor(t,s,i){super(s),this.code=t,this.customData=i,this.name=i0,Object.setPrototypeOf(this,Un.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Em.prototype.create)}}class Em{constructor(t,s,i){this.service=t,this.serviceName=s,this.errors=i}create(t,...s){const i=s[0]||{},r=`${this.service}/${t}`,o=this.errors[t],l=o?r0(o,i):"Error",c=`${this.serviceName}: ${l} (${r}).`;return new Un(r,c,i)}}function r0(e,t){return e.replace(a0,(s,i)=>{const r=t[i];return r!=null?String(r):`<${i}?>`})}const a0=/\{\$([^}]+)}/g;class Pa{constructor(t,s,i){this.name=t,this.instanceFactory=s,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tx=K0;function Pn(e,t,s){var i;let r=(i=J0[e])!==null&&i!==void 0?i:e;s&&(r+=`-${s}`);const o=r.match(/\s|\//),l=t.match(/\s|\//);if(o||l){const c=[`Unable to register library "${r}" with version "${t}":`];o&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),rs.warn(c.join(" "));return}Ea(new Pa(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dx(e){Ea(new Pa("platform-logger",t=>new k0(t),"PRIVATE")),Ea(new Pa("heartbeat",t=>new ox(t),"PRIVATE")),Pn(Kl,Gu,e),Pn(Kl,Gu,"esm2017"),Pn("fire-js","")}dx("");var ux="firebase",hx="10.14.1";/**
 * @license
...
`).map($=>$.trim()).filter($=>$.length>0).join(`
`).trim().toLowerCase(),j=(Y,$,J)=>{const H=J?P:E,q=H(Y),ie=H($);if(q===ie)return!0;const ve=q.replace(/\n/g," ").replace(/\s+/g," "),we=ie.replace(/\n/g," ").replace(/\s+/g," ");if(ve===we)return!0;const ye=Je=>Je.replace(/[;\s]/g,"");return ye(q)===ye(ie)},Q=(Y,$)=>{const J=ye=>ye.toString().toLowerCase().trim().replace(/\s+/g," ").replace(/\s*=\s*/g,"=").replace(/[,;\n]+/g,",").replace(/\s+and\s+/gi,",").replace(/\s*,\s*/g,",").replace(/,+$/,"").replace(/^,+/,""),H=J(Y),q=J($);if(H===q)return!0;if(q.includes("=")){const ye=it=>{const Lt=it.split(",").filter(Ot=>Ot.includes("="));return new Set(Lt.map(Ot=>Ot.trim()))},Je=ye(H),Qe=ye(q);if(Je.size===Qe.size){let it=!0;if(Qe.forEach(Lt=>{Je.has(Lt)||(it=!1)}),it)return!0}}const ie=H.match(/\d+/g)||[],ve=q.match(/\d+/g)||[];if(ie.length===1&&ve.length===1&&ie[0]===ve[0])return!0;const we=ye=>ye.replace(/[^a-z0-9]/g,"");return we(H)===we(q)},X=()=>{var J;let Y=!1;const $=c.type==="js-to-pseudocode";if(c.type==="fill-blank"){if(c.blankAnswers)Y=Object.entries(c.blankAnswers).every(([H,q])=>{const ie=(x[H]||"").trim().toLowerCase();return Array.isArray(q)?q.some(ve=>ve.toLowerCase()===ie):q.toLowerCase()===ie});else if(c.answer){const H=p.trim().toLowerCase(),q=c.answer.toString().trim().toLowerCase();Y=H===q,!Y&&c.acceptableAnswers&&(Y=c.acceptableAnswers.some(ie=>H===ie.toString().trim().toLowerCase()))}}else c.type==="trace"||c.type==="multiple-choice"?(Y=Q(p,c.answer),!Y&&c.acceptableAnswers&&(Y=c.acceptableAnswers.some(H=>Q(p,H)))):(Y=j(p,c.answer,$),!Y&&c.acceptableAnswers&&(Y=c.acceptableAnswers.some(H=>j(p,H,$))));if(R(Y),N(!0),Y||g(H=>H+1),l){const H=c.type==="fill-blank"&&c.blankAnswers?JSON.stringify(x):p;l({exerciseId:c.id,answer:H,isCorrect:Y,exerciseType:"pseudocode",exerciseTitle:((J=c.prompt)==null?void 0:J.substring(0,50))||c.id})}Y&&!i&&t(c.id,10)},ee=()=>{N(!1),R(!1),z(!1)},se=()=>{k&&r?r(k):s()},M=()=>{var Y;S<(((Y=c.hints)==null?void 0:Y.length)||0)-1&&D(S+1)},B=()=>{if(c.template){const Y=c.template.split(/(___\w+___)/g);return n.jsx("div",{className:"fill-blank-container",children:n.jsx("pre",{className:"fill-blank-code",children:Y.map(($,J)=>{const H=$.match(/___(\w+)___/);if(H){const q=H[1];return n.jsx("input",{type:"text",className:`fill-blank-input ${C?I?"correct":"incorrect":""}`,value:x[q]||"",onChange:ie=>v({...x,[q]:ie.target.value}),placeholder:"...",disabled:C&&I},J)}return n.jsx("span",{children:$},J)})})})}if(c.given){const Y=c.given.split(/(_{2,})/g);return n.jsx("div",{className:"fill-blank-container",children:n.jsx("pre",{className:"fill-blank-code",children:Y.map(($,J)=>/^_{2,}$/.test($)?n.jsx("input",{type:"text",className:`fill-blank-input ${C?I?"correct":"incorrect":""}`,value:p,onChange:H=>w(H.target.value),placeholder:"...",disabled:C&&I},J):n.jsx("span",{children:$},J))})})}return null};return n.jsxs("div",{className:"translation-exercise",children:[n.jsx("button",{className:"back-btn",onClick:s,children:"← Back to Pseudocode Hub"}),n.jsxs("div",{className:"exercise-header",children:[n.jsx("h1",{children:(h==null?void 0:h.title)||"Translation Exercise"}),n.jsxs("div",{className:"exercise-meta",children:[n.jsx("span",{className:`difficulty-badge ${c.difficulty}`,children:c.difficulty}),n.jsx("span",{className:"exercise-type-badge",children:c.type.replace(/-/g," ")}),i&&n.jsx("span",{className:"completed-badge",children:"✓ Completed"})]})]}),n.jsx("p",{className:"exercise-prompt-text",children:c.prompt}),c.type==="fill-blank"?B():c.type==="trace"||c.type==="multiple-choice"?n.jsxs("div",{className:"trace-exercise",children:[n.jsxs("div",{className:"code-panel full-width",children:[n.jsx("div",{className:"code-panel-header given",children:(O=c.given)!=null&&O.includes("←")||(U=c.given)!=null&&U.includes("DISPLAY")||(Z=c.given)!=null&&Z.includes("REPEAT")?"Pseudocode":"Code"}),n.jsx("div",{className:"code-panel-content",children:n.jsx("pre",{children:c.given})})]}),c.type==="multiple-choice"&&c.options?n.jsx("div",{className:"multiple-choice-options",children:c.options.map((Y,$)=>n.jsxs("label",{className:`mc-option ${p===Y?"selected":""} ${C?Y===c.answer?"correct-answer":p===Y&&!I?"wrong-answer":"":""}`,children:[n.jsx("input",{type:"radio",name:"mc-answer",value:Y,checked:p===Y,onChange:J=>w(J.target.value),disabled:C&&I}),n.jsx("span",{children:Y})]},$))}):n.jsxs("div",{className:"trace-answer",children:[n.jsx("label",{children:"Your Answer:"}),n.jsx("input",{type:"text",value:p,onChange:Y=>w(Y.target.value),placeholder:"Enter the result...",disabled:C&&I,className:"trace-input"})]})]}):n.jsxs("div",{className:"code-panels",children:[n.jsxs("div",{className:"code-panel",children:[n.jsx("div",{className:"code-panel-header given",children:c.type==="pseudocode-to-js"?"Pseudocode":"JavaScript"}),n.jsx("div",{className:"code-panel-content",children:n.jsx("pre",{children:c.given})})]}),n.jsxs("div",{className:"code-panel",children:[n.jsx("div",{className:"code-panel-header answer",children:c.type==="pseudocode-to-js"?"Your JavaScript":"Your Pseudocode"}),n.jsx("div",{className:"code-panel-content",children:n.jsx("textarea",{value:p,onChange:Y=>w(Y.target.value),placeholder:"Type your answer here...",disabled:C&&I})})]})]}),(c.type==="pseudocode-to-js"||c.type==="js-to-pseudocode")&&n.jsx("div",{className:"format-help",children:n.jsxs("details",{children:[n.jsx("summary",{children:"Accepted formats"}),n.jsxs("ul",{children:[n.jsxs("li",{children:[n.jsx("code",{children:"←"})," or ",n.jsx("code",{children:"<--"})," or ",n.jsx("code",{children:"<-"})," for assignment"]}),n.jsxs("li",{children:[n.jsx("code",{children:"DISPLAY(x)"})," or ",n.jsx("code",{children:"DISPLAY x"})," for output"]}),n.jsxs("li",{children:[n.jsx("code",{children:"≠"})," or ",n.jsx("code",{children:"!="})," or ",n.jsx("code",{children:"<>"})," for not equal"]}),n.jsxs("li",{children:[n.jsx("code",{children:"≥"})," or ",n.jsx("code",{children:">="})," and ",n.jsx("code",{children:"≤"})," or ",n.jsx("code",{children:"<="})]}),n.jsx("li",{children:"Spacing and newlines are flexible"})]})]})}),n.jsx("div",{className:"exercise-actions",children:C?n.jsx(n.Fragment,{children:!I&&n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"action-btn",onClick:ee,children:"Try Again"}),(c.type==="pseudocode-to-js"||c.type==="js-to-pseudocode")&&n.jsx("button",{className:"action-btn highlight-btn",onClick:()=>z(!_),children:_?"Hide Errors":"Highlight Errors"}),b>=5&&n.jsx("button",{className:"action-btn skip-btn",onClick:se,children:"Skip Activity →"})]})}):n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"action-btn",onClick:()=>f(!m),children:m?"Hide Hints":"Show Hints"}),n.jsx("button",{className:"action-btn primary",onClick:X,disabled:c.type==="fill-blank"&&c.blankAnswers?Object.keys(x).length===0:!p.trim(),children:"Check Answer"})]})}),m&&c.hints&&c.hints.length>0&&n.jsxs("div",{className:"hint-box",children:[n.jsx("h4",{children:"Hints"}),n.jsx("ul",{children:c.hints.slice(0,S+1).map((Y,$)=>n.jsx("li",{children:Y},$))}),S<c.hints.length-1&&n.jsx("button",{className:"action-btn",onClick:M,children:"Show Next Hint"})]}),C&&n.jsx("div",{className:`result-box ${I?"correct":"incorrect"}`,children:I?n.jsxs(n.Fragment,{children:[n.jsx("h3",{children:"✓ Correct!"}),n.jsx("p",{children:"Great job! You've mastered this translation."}),k&&r&&n.jsx("button",{className:"action-btn primary next-activity-btn",onClick:()=>r(k),children:"Next Activity →"}),!k&&n.jsx("p",{className:"completion-message",children:"You've completed all exercises in this section!"})]}):n.jsxs(n.Fragment,{children:[n.jsx("h3",{children:"✗ Not Quite"}),n.jsx("p",{children:"Check your answer and try again."}),n.jsxs("p",{className:"attempt-counter",children:["Attempt ",b," of 5",b>=5&&" - You can now skip this activity"]})]})}),C&&!I&&n.jsxs("div",{className:"explanation-box",children:[n.jsx("h4",{children:"Explanation"}),n.jsx("p",{children:c.explanation})]})]})}const Jo=[{id:"trace-1",title:"Simple Counter",code:`count ← 0
REPEAT 3 TIMES
{
   count ← count + 1
   DISPLAY(count)
...
Your server code is ready in the "Server" tab.
      `.trim());else try{const O=E(l);if(k.current){const U=k.current,Z=U.contentDocument||U.contentWindow.document;Z.open(),Z.write(O),Z.close()}_("Code running in preview...")}catch(O){_(`Error: ${O.message}`)}},E=O=>{var H,q;const U=(H=o.libraries)==null?void 0:H.includes("leaflet"),Z=(q=o.libraries)==null?void 0:q.includes("chartjs"),Y=!U&&!Z;let $="",J="";return Y&&($+='<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.9.0/p5.min.js"><\/script>'),U&&(J+='<link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />',$+='<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"><\/script>'),Z&&($+='<script src="https://cdn.jsdelivr.net/npm/chart.js"><\/script>'),`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
