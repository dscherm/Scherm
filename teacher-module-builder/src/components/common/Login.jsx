      ...
      <div className="max-w-md w-full animate-fade-in">
        ...
        <div className="card-glass">
          ...
          <p className="text-sm text-text-muted text-center mt-6">
            Google sign-in enables Google Slides integration for automatic lesson slide generation.
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="text-center">
            <div className="w-12 h-12 bg-yellow-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
              <span className="text-2xl">5E</span>
            </div>
            <p className="text-xs text-text-muted">5E Framework</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
              <span className="text-2xl">📊</span>
            </div>
            <p className="text-xs text-text-muted">Auto Slides</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
              <span className="text-2xl">👥</span>
            </div>
            <p className="text-xs text-text-muted">Team Roles</p>
          </div>
        </div>
      </div>
    </div>
